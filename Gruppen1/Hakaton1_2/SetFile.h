...
int appendSetFile(const char* fname, FTYPE x);

int popSetFile(const char* fname, FTYPE x);

bool isSetFileContaines(const char* fname, FTYPE x);
...
FTYPE diameterSetFile(const char* fname);
